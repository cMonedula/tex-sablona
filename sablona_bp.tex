...
\captionsetup[table]{labelsep=space,justification=centerlast,singlelinecheck=off,font=small}
\captionsetup[figure]{labelsep=space,justification=centerlast,font=small}
% pokiaľ chceš mať písmo popiskov rovnakej veľkosti ako text, použi nasledujúce riadky
% \captionsetup[table]{labelsep=space,justification=centerlast,singlelinecheck=off}
% \captionsetup[figure]{labelsep=space,justification=centerlast}
...
\input{titulna_strana_projekt2}

%\input{uvodne_strany} % vloženie úvodných strán
\input{uvodne_strany_projekt} % vloženie úvodných strán
